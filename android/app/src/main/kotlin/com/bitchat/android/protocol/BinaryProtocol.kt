...
enum class MessageType(val value: UByte) {
    ...
    CRITICAL_ALERT(0x30u), // Structured critical data alert
    DELIVERY_ACK(0x31u),   // Cryptographic delivery receipt
    BRIDGE_SYNC(0x32u);    // Bridge telemetry and sync packet
