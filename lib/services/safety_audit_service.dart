  ...
  Future<List<LeaderboardEntry>> fetchLeaderboard({
    ...
    return [
      ...
      LeaderboardEntry(
        rank: 5,
        userId: 'USER_005',
        displayName: 'Ramdaspeth_Watcher',
        points: 15,
        level: 1,
        levelTitle: 'Safeti-Starter',
        badgesCount: 1,
